                            ...
                            if (!(b instanceof W)) {
                              ...
                              if (w) {
                                ...
                                L && ((C = I(t, C, L)), (k += L.length)),
                                    z(t, C, x);
                                var _ =
                                    new W(o, g ? M.tokenize(O, g) : O, v, O);
                                (y = I(t, C, _)), N && I(t, y, N),
...
!(function() {
  if ("undefined" != typeof self && self.Prism && self.document &&
    ...
    var t, s = function() {
      if (void 0 === t) {
        ...
        (e.style.fontSize = "13px"), (e.style.lineHeight = "1.5"),
            (e.style.padding = "0"), (e.style.border = "0"),
            (e.innerHTML = "&nbsp;<br />&nbsp;"), document.body.appendChild(e),
            (t = 38 === e.offsetHeight), document.body.removeChild(e);
      }
      return t;
    }, l = !0, a = 0;
                        ...
                        function e(t) {
                          ...
                          if (n && i && /pre/i.test(n.nodeName)) {
                            ...
                            if (b(n, "line-numbers") && r && !o)
                              ...
                              u(n, i)(), (a = setTimeout(c, 1));
                          }
                        }),
        window.addEventListener("hashchange", c),
        window.addEventListener("resize", function() {
          g("pre[data-line]").map(function(e) { return u(e); }).forEach(v);
        });
  }
  function g(e, t) {
  ...
  function u(u, e, c) {
    var t = (e = "string" == typeof e ? e : u.getAttribute("data-line"))
        ...
        m = b(u, "line-numbers"), p = m ? u : u.querySelector("code") || u,
        h = [];
    t.forEach(function(e) {
      var t = e.split("-"), n = +t[0], i = +t[1] || n,
          r = u.querySelector('.line-highlight[data-range="' + e + '"]') ||
    ...
    if (m && i) {
      ...
      if (r) {
        b(u, n) ||
            h.push(
                function() { u.className = (u.className + " " + n).trim(); });
    ...
    if (t && !document.getElementById(e)) {
      ...
      if (i)
        i.hasAttribute("data-line") || i.setAttribute("data-line", ""),
            u(i, t, "temporary ")(),
            l && document.querySelector(".temporary.line-highlight")
                     .scrollIntoView();
    }
  }
})();
    ...
    var e = (Prism.plugins.toolbar.registerButton = function(e, n) {
      ...
      (t =
          ...
          if (e && /pre/i.test(e.nodeName) &&
            ...
            t.classList.add("code-toolbar"), e.parentNode.insertBefore(t, e),
                t.appendChild(e);
            ...
            o && (n = o.map(function(e) { return l[e] || c; })),
  ...
  if ("undefined" != typeof self && self.Prism && self.document)
    if (Prism.plugins.toolbar) {
      ...
      Prism.plugins.toolbar.registerButton("copy-to-clipboard", function(o) {
        ...
        function n() {
          var o = new i(t, {
            text : function() { return e.textContent; },
          });
          o.on("success", function() { (t.textContent = "Copied!"), r(); }),
              o.on("error", function() {
                (t.textContent = "Press Ctrl+C to copy"), r();
              });
        }
        function r() {
          setTimeout(function() { t.textContent = "Copy"; }, 5e3);
        }
      });
    } else
